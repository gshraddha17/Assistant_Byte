...
if __name__ == "__main__":
    ...
    while True:
        ...
        if choice == "exit":
            ...
            api_key='f1415abbe38e407dbd78339b4875304a'
            ...
            auth_token = 'b3957865d128ff412eaba75a0bc4eab7'
        ...
        elif choice in ['send a mail']:
            

            smtp_server = 'smtp.gmail.com'
            port = 465
            username = 'lcs2021021@iiitl.ac.in'
            password = 'epuigmowjjzwuriy'

            smtp = smtplib.SMTP_SSL(smtp_server, port)
            smtp.ehlo()
            smtp.login(username, password)

            from_email = 'lcs2021021@iiitl.ac.in'
            to_email = input()
            subject = 'Mail from Byte'
            body = "Hello, this is a msg from Byte"
